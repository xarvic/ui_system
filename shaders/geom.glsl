...
void main() {
    ...
    if(rounded){
        ...
        vo_border = v_radius[1];
        //start
        color = v_color[0];
        vi_border = v_radius[1] - v_width[0];
        ...
        vi_border = v_radius[1] - (v_width[0] + v_width[1]) / 2;
        ...
        //end
        color = v_color[1];
        vi_border = v_radius[1] - v_width[1];
